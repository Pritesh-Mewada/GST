...
import com.graphysis.gst.CalculateRecycleAdapter;
import com.graphysis.gst.Calculator;
import com.graphysis.gst.R;
import com.graphysis.gst.Storage;
import com.graphysis.gst.Tables;
...
public class ServiceCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(ServiceCalculator.this);
        priceMap = new HashMap<String,Float>();
        goods = new Storage(ServiceCalculator.this);
        recyclerViewCalculator.setLayoutManager(new LinearLayoutManager(this));
        calculateRecycleAdapter = new CalculateRecycleAdapter(ServiceCalculator.this,1);
        ...
        getSupportActionBar().setTitle("Service Calculator");
    ...
    public void initialiseAdapter(){
        ...
        //initialise the data
        Cursor cursor = goods.readItems(Tables.serviceItem);
        do{
        ...
        //get stored data
        cursor = goods.read(Tables.serviceStore);
        ...
        addItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                goods.Insert(calculator,Tables.serviceStore);
